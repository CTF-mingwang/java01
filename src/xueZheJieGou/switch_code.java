        ...
        if (xz == 1) {
            ...
            switch (xz_2) {
                case 1:
                    ...
                    switch (xz_3) {
                        ...
                        case 2:
                            ...
                            break;
                        default:
                            System.out.println("数据输入有误，请输入：1 或 2 ！！！");
                    }
                    break;
                case 2:
                ...
                case 6:
                    ...
                    switch (xz_8) {
                        case "exit":
                            System.out.println("感谢你对本程序的支持！！！");
                            break;
                        default:
                            System.out.println("数据输入错误，请按提示输入");
                            break;
                    }
                    break;
                default:
                    System.out.println("数据输入有误，请输入：1 - 6 之间的整数！！！");
            }
        } else if (xz == 2) {
                ...
                case 1:
                    ...
                    switch (xz_3) {
                        ...
                        case 2:
                            ...
                            break;
                        default:
                            System.err.println("数据输入有误，请输入：1 或 2 ！！！");
                    }
                    break;
                case 2:
                    System.out.println("举目四望");
                ...
                case 6:
                    ...
                    switch (xz_8) {
                        case "exit":
                            ...
                            break;
                        default:
                            System.err.println("数据输入错误，请按提示输入");
                            break;
                    }
                    break;
                default:
                    System.err.println("数据输入有误，请输入：1 - 6 之间的整数！！！");
            }
        } else if (xz == 2) {
            System.exit(0); //正常退出Java应用程序（Java Application）
        } else {
            System.err.println("数据输入错误，请输入：1 或 2 ！！！");
        }
    }
}
